...
public class MinimarketProgram {
    ...
    private static final String DB_USERNAME = "HeniYunida";
    private static final String DB_PASSWORD = "123Heni";
    ...
    public static void main(String[] args) {
        ...
        if ((user.equals("HeniYunida")) && (sandi.equals("123Heni"))) {
        ...
        System.out.println("Menampilkan data dari database:");
        displayDataFromDatabase();

        // Update data di database
        System.out.println("Update data di database:");
        updateDataInDatabase();

        // Menampilkan data dari database setelah update
        System.out.println("Menampilkan data dari database setelah update:");
        displayDataFromDatabase();

        // Delete data di database
        System.out.println("Delete data di database:");
        updateDataInDatabase();

        // Menampilkan data dari database setelah delete
        System.out.println("Menampilkan data dari database setelah delete:");
        displayDataFromDatabase();
    }

    private static void displayDataFromDatabase() {
    }
    ...
    private static void displayTransaction(Penjualan penjualan) {
        ...
        System.out.println("Waktu     : " + timeFormat.format(new Date()));
        System.out.println("========================");
